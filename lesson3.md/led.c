...
void loop()
{
  while(Serial.available()>0)
  {
  	...
  	switch(i)
    {
      ...
      case 1:digitalWrite(3,HIGH);digitalWrite(4,HIGH);
      ...
      case 3:digitalWrite(2,HIGH);digitalWrite(3,HIGH);
             ...
             digitalWrite(7,LOW);
             break;
      case 4:digitalWrite(3,HIGH);digitalWrite(4,HIGH);
             digitalWrite(7,HIGH);digitalWrite(8,HIGH);
             digitalWrite(2,LOW);digitalWrite(5,LOW);
             digitalWrite(6,LOW);break;
      case 5:digitalWrite(2,HIGH);digitalWrite(8,HIGH);
             digitalWrite(4,HIGH);digitalWrite(5,HIGH);
             digitalWrite(6,HIGH);digitalWrite(3,LOW);
             digitalWrite(7,LOW);
             break;
      case 6:digitalWrite(2,HIGH);digitalWrite(4,HIGH);
             digitalWrite(5,HIGH);digitalWrite(6,HIGH);
             digitalWrite(7,HIGH);digitalWrite(8,HIGH);
